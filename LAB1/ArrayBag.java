...
// equals bag[where]; otherwise, anEntry is not in the array
    ...
    public boolean duplicateAll() {
        ...
        if(numberOfEntries*2<=bag.length){
             ...
             numberOfEntries=numberOfEntries*2;
             success=true;
        }else{
        	System.err.println("This array cannot be duplicated because of size.");
    ...
    public void removeDuplicates() {
        ...
        for(int i=0;i<numberOfEntries;i++){
        	if(contains(bag[i])){
        		int dupIndex=getIndexOf(bag[i]);
        		if(i!=dupIndex&&i>dupIndex){
        			removeEntry(i);
        			i--;
        		}
        	}
